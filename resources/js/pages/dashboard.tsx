            ...
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-6 bg-gradient-to-br from-background to-muted/20">
                <div className="flex justify-between items-center">
                    <div>
                        ...
                        <Link href={route('lists.index')}>
                            <Button className="bg-blue-500 hover:bg-white/90 text-black shadow-lg">
                                <List className="h-4 w-4 mr-2" />
                                View  Lists
                            </Button>                        
                            </Link>                        
                            <Link href={route('tasks.index')}>
                            <Button className="bg-black hover:bg-red-500/90 text-white shadow-lg">
                ...
                <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                    <Card className="bg-gradient-to-br from-purple-500/10 to-purple-600/10 border-purple-500/20">
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold text-purple-500">{stats.totalLists}</div>                           
                    ...
                    <Card className="bg-gradient-to-br from-yellow-500/10 to-yellow-600/10 border-yellow-500/20">
                        ...
                        <CardContent>
                            ...
                            <p className="text-xs text-muted-foreground">Tasks to completed</p>
                        </CardContent>                   
                        </Card>
                    <Card className="bg-gradient-to-br from-green-500/10 to-green-600/10 border-green-500/20">
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold text-green-500">{stats.completedTasks}</div>                     
                                <p className="text-xs text-muted-foreground">Task Already Completed</p>
                        </CardContent>                   
                        </Card>                
                    </div>
