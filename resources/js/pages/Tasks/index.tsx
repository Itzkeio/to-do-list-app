            ...
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-6 bg-gradient-to-br from-background to-muted/20">
                ...
                <div className="flex justify-between items-center">
                    <div>
                        ...
                        <p className="text-muted-foreground mt-1">Stay organized bro</p>      
                        </div> <Dialog open={isOpen} onOpenChange={setIsOpen}>
                        <DialogTrigger  >
                            <Button className="bg-white hover:bg-green-500 text-black shadow-lg">
                            ...
                            <DialogHeader>
                                ...
                                <div className="flex items-center space-x-2">
                                    ...
                                    <Label htmlFor="is_completed">Completed</Label>                                </div>                                <Button
                                        type="submit"
                                        disabled={processing}
                                        className="w-full bg-green-500 hover:bg-green-500/90 text-black shadow-lg"
                                    >
